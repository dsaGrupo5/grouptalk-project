...
public interface GrouptalkMediaType {
    ...
    public final static String GROUPTALK_GRUPO_COLLECTION = "application/vnd.dsa.grouptalk.grupo+json";
    public final static String GROUPTALK_TEMA_COLLECTION = "application/vnd.dsa.grouptalk.grupo+json";
