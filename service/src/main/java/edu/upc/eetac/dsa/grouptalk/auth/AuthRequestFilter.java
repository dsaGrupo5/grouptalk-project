...
public class AuthRequestFilter implements ContainerRequestFilter
{
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException
    {
        ...
        try
        {
            ...
            if (principal == null)throw new WebApplicationException("auth token doesn't exists", Response.Status.UNAUTHORIZED);
             ...
             new SecurityContext()
                {
                    ...
                    @Override
                    public String getAuthenticationScheme(){return "X-Auth-Token";}
                }
            );
        }
